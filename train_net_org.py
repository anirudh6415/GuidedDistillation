...
def main(args):
    ...
    if args.eval_only:
        ...
        # ema.may_build_model_ema(cfg, model)
        # DetectionCheckpointer(model, save_dir=cfg.OUTPUT_DIR,**ema.may_get_ema_checkpointer(cfg, model)).resume_or_load(
        #     cfg.MODEL.WEIGHTS, resume=args.resume
        # )
        # checkpointer = DetectionCheckpointer(model, save_dir=cfg.OUTPUT_DIR,**ema.may_get_ema_checkpointer(cfg, model))
