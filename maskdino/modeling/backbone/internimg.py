...
from maskdino.layers import dcn_v3 as opsm
    ...
    def forward(self, x):
        ...
        for level_idx, level in enumerate(self.levels):
            ...
            if level_idx in self.out_indices:
                ...
                seq_out["res{}".format(level_idx)] = x_.permute(0, 3, 1, 2).contiguous()
        return seq_out
...
class INTERNIMAGE(InternImage , Backbone):
    def __init__(self,cfg,input_shape):
        in_chans_internimg = cfg.MODEL.InternImage.channels 
        depths_internimg  = cfg.MODEL.InternImage.DEPTHS
        groups = cfg.MODEL.InternImage.groups 
        drop_path_rate_internimg = cfg.MODEL.InternImage.DROP_RATE
        post_norm = cfg.MODEL.InternImage.post_norm
        out_indices_convnext = (0,1,2,3)
        super().__init__(
            channels=in_chans_internimg,
            depths=depths_internimg,
            groups=groups,
            drop_path_rate=drop_path_rate_internimg,
            post_norm=post_norm,
