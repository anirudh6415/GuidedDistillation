...
def add_maskdino_config(cfg):
    ...
    cfg.MODEL.MaskDINO.MASK_LOSS = False
    ...
    cfg.MODEL.CONV = CN()
    cfg.MODEL.CONV.DEPTHS = [3, 3, 27, 3]
    cfg.MODEL.CONV.DIM =[192, 384, 768, 1536]
    cfg.MODEL.CONV.DROP_RATE = 0.0
    cfg.MODEL.CONV.LAYER_SCALE = 1.0
    cfg.MODEL.CONV.OUT_FEATURES = ["res2", "res3", "res4", "res5"]

    ## Intern Image backbone 
    cfg.MODEL.InternImage = CN()
    cfg.MODEL.InternImage.channels = 112
    cfg.MODEL.InternImage.DEPTHS = [4,4,21,4]
    cfg.MODEL.InternImage.groups = [7,14,28,56]
    cfg.MODEL.InternImage.DROP_RATE = 0.1
